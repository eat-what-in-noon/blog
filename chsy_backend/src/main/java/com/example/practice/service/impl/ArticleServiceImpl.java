...
public class ArticleServiceImpl implements ArticleService {
    ...
    public Map<String, Object> uploadCover(MultipartFile cover) throws IOException {
        String uploadPath = "D:/原桌面文件/学习笔记/实习/中午吃什么/blog-chsy_backend/src/main/resources/static/cover/";
    ...
    public Map<String, Object> getComment(Integer id) {
        ...
        return Map.of("error_message", "success", "data", commentList, "users", users);
    }
